...
const Header = () => {
  return (
    <header className='header'>
      ...
      <div className='header-content flex items-center justify-center flex-col text-center'>
        ...
        <h1 className='text-white text-4xl font-bold header-title ls-2'>CROWN LITE EXCLUSIVE HUB LIMITED</h1>
        <h1 className='text-white text-2xl font-bold header-title ls-2'>Welcome to our Course Listing Website</h1>
  ...
  <button className=' w-24 h-[40px] bg-white rounded-md font-semibold hover:bg-[#4c956c] hover:text-white'>About Us</button>
     ...
     <Link to="/team">
     <button className=' w-40 h-[40px] bg-white rounded-md font-semibold hover:bg-[#4c956c] hover:text-white'>Meet our Tutor</button>
     </Link>
      </div>
      </div>
